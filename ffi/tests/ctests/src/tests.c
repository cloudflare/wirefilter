...
void wirefilter_ffi_ctest_add_values_to_execution_context()
{
    ...
    rust_assert(wirefilter_add_bytes_value_to_execution_context(
                    exec_ctx,
                    STRING("http.host"),
                    BYTES("www.cloudflare.com")) == true,
                "could not set value for field http.host");
    ...
    rust_assert(wirefilter_add_ipv4_value_to_execution_context(
                    ...
                    STRING("ip.src"),
                    &ipv4_addr) == true,
                "could not set value for field ip.src");
    ...
    rust_assert(wirefilter_add_bool_value_to_execution_context(
                    ...
                    STRING("ssl"),
                    false) == true,
                "could not set value for field ssl");

    rust_assert(wirefilter_add_int_value_to_execution_context(
                    exec_ctx,
                    STRING("tcp.port"),
                    80) == true,
                "could not set value for field tcp.port");
...
void wirefilter_ffi_ctest_add_values_to_execution_context_errors()
{
    ...
    rust_assert(wirefilter_add_bytes_value_to_execution_context(
                    exec_ctx,
                    STRING("doesnotexist"),
                    BYTES("www.cloudflare.com")) == false,
                "managed to set value for non-existent bytes field");
    ...
    rust_assert(wirefilter_add_ipv4_value_to_execution_context(
                    ...
                    STRING("doesnotexist"),
                    &ipv4_addr) == false,
                "managed to set value for non-existent ipv4 field");
    ...
    rust_assert(wirefilter_add_ipv6_value_to_execution_context(
                    ...
                    STRING("doesnotexist"),
                    &ipv6_addr) == false,
                "managed to set value for non-existent ipv6 field");

    rust_assert(wirefilter_add_bool_value_to_execution_context(
                    exec_ctx,
                    STRING("doesnotexist"),
                    false) == false,
                "managed to set value for non-existent bool field");
